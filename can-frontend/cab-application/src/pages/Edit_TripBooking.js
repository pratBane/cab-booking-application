...
class Edit_TripBooking extends React.Component {
    render() {
        return (
            <div>
                <Header />
                        ...
                        <div class="row">
                            <form action="" class="contact-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col span-2-of-3">
                                        <input type="hidden" name="tripbooking_id" id="tripbooking_id"/>
...
export default Edit_TripBooking;